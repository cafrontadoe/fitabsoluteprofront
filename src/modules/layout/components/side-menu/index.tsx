          ...
          {({ open, close }) => (
            <>
              <div className="relative flex h-full">
                <Popover.Button className="color-d4 relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none hover:text-ui-fg-base">
                  Menu
                </Popover.Button>
              </div>
                  ...
                  <div className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] rounded-rounded justify-between p-6">
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small">
                        © {new Date().getFullYear()} Fit Absolute Pro. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
